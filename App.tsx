...
import { ViewState, Member, Project, Status, Department, Level, Action } from './types';
      ...
      const fetchData = async () => {
        try {
          ...
          if (membersRes.ok && projectsRes.ok) {
            ...
            setMembers(membersData.users || membersData || []);
      ...
      default:
        return (
          <div className="flex flex-col items-center justify-center h-[60vh] space-y-4">
            <h2 className="text-4xl font-header font-black uppercase tracking-[0.3em] text-rudore-text/10">{currentView}</h2>
            <p className="text-rudore-text/40 font-mono text-[10px] uppercase tracking-widest border border-rudore-border p-4">Phase d'initialisation du module...</p>
          </div>
        );
    }
  };
    ...
    <div className="min-h-screen bg-rudore-black text-rudore-light flex font-sans selection:bg-rudore-orange selection:text-black">
      ...
      <main className="flex-1 lg:ml-64 p-4 lg:p-12 overflow-y-auto h-screen w-full transition-all duration-300">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12 lg:mb-16 gap-6 relative z-10">
          ...
          <div className="flex items-center space-x-0 ml-auto sm:ml-0 bg-rudore-panel shadow-[6px_6px_0px_rgba(0,0,0,0.05)] dark:shadow-[6px_6px_0px_rgba(0,0,0,0.3)]">
